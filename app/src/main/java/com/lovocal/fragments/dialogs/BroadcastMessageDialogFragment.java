...
package com.lovocal.fragments.dialogs;
...
public class BroadcastMessageDialogFragment extends DialogFragment {
    ...
    private EditText            mMessageQuery;
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        mMessageQuery = (EditText) contentView
                        .findViewById(R.id.query_message);
    ...
    public String getMessage() {
        return mMessageQuery.getText().toString();
    }
