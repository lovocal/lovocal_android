...
public class FlatSeekBar extends SeekBar implements Attributes.AttributeChangeListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, com.lovocal.R.styleable.FlatSeekBar);

            // getting common attributes
            int customTheme = a.getResourceId(com.lovocal.R.styleable.FlatSeekBar_theme_flat, Attributes.DEFAULT_THEME);
            attributes.setThemeSilent(customTheme, getResources());

            attributes.setSize(a.getDimensionPixelSize(com.lovocal.R.styleable.FlatSeekBar_size, Attributes.DEFAULT_SIZE_PX));
