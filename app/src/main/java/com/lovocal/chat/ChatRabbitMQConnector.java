...
//                                                   };
     ...
     * 
     * @param routingKey
     * @throws java.io.IOException If the binding could not be done
     */
     ...
     * @throws java.io.IOException If the queue could not be declared
     */
     ...
     * @throws java.io.IOException If the binding could not be removed
     */
