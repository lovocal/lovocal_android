 ...
 */
class LavocalSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    private static LavocalSQLiteOpenHelper                  sSQLiteOpenHelper;
     ...
     * @return the reference to {@link LavocalSQLiteOpenHelper}
     */
    static LavocalSQLiteOpenHelper getInstance(final Context context) {
        ...
        synchronized (LOCK) {
            ...
            if (sSQLiteOpenHelper == null) {
                ...
                synchronized (LOCK) {
                    ...
                    sSQLiteOpenHelper = new LavocalSQLiteOpenHelper(context.getApplicationContext(), DB_NAME, null, DB_VERSION);
                }
            }
        }
     ...
     * @param version
     */
    private LavocalSQLiteOpenHelper(final Context context, final String name, final CursorFactory factory, final int version) {
    ...
    public void onCreate(final SQLiteDatabase db) {
        ...
        //Create Views
        ViewChatsWithServiceToUserMessages.create(db);
    ...
    public void onUpgrade(final SQLiteDatabase db, final int oldVersion,
        ...
        //Upgrade tables
        TableCategories.upgrade(db, oldVersion, newVersion);
        ...
        //Upgrade Views
        ViewChatsWithServiceToUserMessages.upgrade(db,oldVersion,newVersion);
