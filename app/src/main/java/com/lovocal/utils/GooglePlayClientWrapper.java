...
public class GooglePlayClientWrapper implements ConnectionCallbacks,
    ...
    private final AbstractLavocalActivity mActivity;
    ...
    public GooglePlayClientWrapper(final AbstractLavocalActivity activity, final LocationListener locationListener) {
        mActivity = activity;
